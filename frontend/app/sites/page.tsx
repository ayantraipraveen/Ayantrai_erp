    ...
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="p-3.5 rounded-xl border border-slate-200 dark:border-zinc-800/80 bg-white dark:bg-[#0d1017] flex items-center justify-between">
          <div>
            ...
            <div className="text-lg font-bold text-[#F6C72F] mt-0.5">ISO 45001</div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {sitesList.map((site) => (
          <div
            key={site.id}
            className="p-5 rounded-2xl border border-slate-200 dark:border-zinc-800/90 bg-white dark:bg-[#0c1017] hover:border-amber-500/50 transition-all flex flex-col justify-between shadow-sm space-y-4"
          >
            <div>
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-mono font-bold text-[#F6C72F] bg-amber-500/10 border border-amber-500/30 px-2 py-0.5 rounded">
                      {site.id}
                    </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4 pt-4 border-t border-slate-100 dark:border-zinc-800/80 text-xs">
                ...
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-900/60 border border-slate-200 dark:border-zinc-800/70 space-y-1.5">
                  <div className="text-[10px] font-mono uppercase font-bold text-amber-500 flex items-center gap-1">
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-zinc-800/80 flex items-center justify-between text-xs">
              ...
              <div className="text-[10px] font-mono text-[#F6C72F] flex items-center gap-1">
          ...
          <div className="w-full max-w-lg rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-[#0c1017] p-6 shadow-2xl space-y-4 text-slate-900 dark:text-white">
            ...
            <form onSubmit={handleCreateSite} className="space-y-3.5">
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-zinc-800">
                <span className="text-[11px] font-mono uppercase font-bold text-amber-500">Assigned Admin Credentials</span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1.5">
                  <input
                    ...
                    className="px-3 py-1.5 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-900 text-xs focus:outline-none focus:border-[#F6C72F]"
                  />
                  <input
                    type="email"
                    value={adminEmail}
