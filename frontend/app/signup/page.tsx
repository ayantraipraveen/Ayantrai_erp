...
export default function SignUpPage() {
  ...
  const [role, setRole] = useState("Safety & EHS Head");
  ...
  return (
    <div className="relative min-h-screen lg:h-screen w-full bg-[#080a0e] text-slate-100 flex flex-col justify-between overflow-y-auto industrial-grid">
      ...
      {/* Main Content Area - Calibrated Single-Frame Fit with Zero Overflow Clipping */}
      <main className="relative z-10 flex-1 w-full max-w-[1680px] mx-auto px-4 sm:px-8 xl:px-12 flex items-center justify-center py-2 lg:py-1 xl:py-2">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 xl:gap-8 items-center my-auto">
          
          {/* ================= LEFT COLUMN: Architecture & Pilot Program (7 Cols) ================= */}
          <div className="lg:col-span-7 xl:col-span-7 flex flex-col justify-center space-y-2.5 sm:space-y-3 xl:space-y-3.5 order-2 lg:order-1">
